...
public class Sql {
    ...
    private String valuesList(Objecct[] fields, final Column[] columns){}
...
public class InsertSql extends Sql{
    ...
    @Override public String generate(){};
    private String valuesList(Object[] fileds, final Column[] Columns){}
}
...
对具体细节的依赖会让测试变得麻烦，比如说现在我们有一个类`Protfolie`，它依赖了一个外部API:`TokyoStockExchange`，
